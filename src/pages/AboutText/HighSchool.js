...
const HighSchool = () => (
  <>
    <Typography className='textBody' variant="body2">
        I attended the prestigious Scholar's Program at Saint Peter's Boys 
        High School on a full academic scholarship in my hometown of Staten 
        Island, New York. While there, I was a member of several 
        volunteer clubs, the student council, and was accepted into the National 
        Honor Society (NHS). 
    </Typography>
    <Typography className='textBody' variant="body2">
